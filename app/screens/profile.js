                ...
                { this.state.loggedin == true ?(
                    ...
                    <View style={{flex:1}}>
                        ...
                        <View style={{justifyContent: 'space-evenly', alignItems: 'center', flexDirection: 'row', paddingVertical: 10}}>
                            <Image source={{ uri : 'https://api.adorable.io/avatars/285/test@user.1.png'}} style={{marginLeft: 10, width:100, height:100, borderRadius: 50}}/> 
                        ...
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'cener', backgroundColor: 'green'}}>
